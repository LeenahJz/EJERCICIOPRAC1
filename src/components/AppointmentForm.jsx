    ...
    return (
        <div className="bg-blue-100 text-white py-12 px-6">
            ...
            {appointments.length > 0 && (
                <div className="mt-6">
                    <h3 className="text-2xl font-bold text-blue-950 mb-4">Scheduled Appointments:</h3>
                    <ul>
                        {appointments.map((appointment) => (
                            <li key={appointment.id} className="mb-2 p-2 bg-white text-blue-900 rounded shadow">
